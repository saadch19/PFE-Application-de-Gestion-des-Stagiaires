...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4 fade-in">
    <div>
        ...
        <p class="text-muted mb-0">Générer les attestations validées et informer les stagiaires.</p>
    </div>
</div>

<div class="card card-soft fade-in mb-4">
    <div class="card-body">
        <h2 class="h5 mb-3">Attestations à traiter</h2>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-inline-flex justify-content-end gap-1 flex-nowrap">
                                    <a href="{{ route('attestations.show', $requestItem->intern) }}" class="btn btn-sm btn-outline-primary text-nowrap">Générer / imprimer</a>
